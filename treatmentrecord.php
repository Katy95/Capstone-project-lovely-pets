					...
					<aside id="petview">
				            ...
				            <nav class="left-nav">
						        <ul style="margin-left:50px; margin-top:30px;">
						    	    <li class="active2"><a href="#all"><h2>Waiting for treatment</h2></a></li>
							        <li><a href="inservice.php"><h2>In service</h2></a></li>
						        </ul>
				        ...
				        <aside id="petview_waiting for treatment">
				            ...
				            <nav class="nav">
				                <ul style="width:87%; margin-left:50px; margin-top:70px;"><h2>All the pets waiting for treatment</h2><br>
					                <li>
										...
										$sql="SELECT * FROM appointment INNER JOIN pet ON appointment.PetID = pet.PetID INNER JOIN staff ON appointment.DoctorID = staff.StaffID WHERE PetCondition='Waiting for treatment'";
										...
										{
											echo "<br>";
											echo "<form method='post' action='starttreatment.php'>";
											...
											echo "<strong style='color: darkgrey;'>Expact operating time: </strong><big style='margin-right:0px;'>" . $row['starttime'] . " to " . $row['endtime'] . "</big><br><br>";
											echo "<strong style='color: darkgrey;'>Service process Condition: </strong>" . $row['PetCondition'] . "";
											
											echo "<button type='submit' name='start' id='start' class='button' value='" . $row['PetID'] . "'  style='margin-left:100px;'>Check Treatment Information</button><br><br>";
								...
								<br><p style="text-align:center">@All the pets waiting for treatment are showing above.@</p>
